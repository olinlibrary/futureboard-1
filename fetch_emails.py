...
def main():
    """
    Connects to gmail account and pulls out all new emails to the
    carpe list, then separates them by month and sends them in
    batches to be stored in a JSON
    """
